       ...
       <div class="row d-flex mb-5 contact-info">
         ...
         <div class="col-md-3 d-flex">
           <div class="con align-self-stretch p-3">
             <p><span>Address:</span>55 Village Center Place, Suite 200, Mississauga, Ontario. L4Z 1V9</p>
           </div>
         </div>
         <div class="col-md-3 d-flex">
           <div class="con align-self-stretch p-3">
         ...
         <div class="col-md">
           <div class="ftco-footer-widget mb-4">
             ...
             <div class="block-23 mb-3">
               <ul>
                 <li><span class="icon icon-map-marker"></span><span class="text">55 Village Center Place, Suite 200, Mississauga, Ontario. L4Z 1V9</span></li>
