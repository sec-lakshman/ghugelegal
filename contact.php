...
?>
 ...
 <body>
   ...
   <section>
    ...
    <h4 style= "color:#bd1010;padding-bottom:120% !important"><b>CONTACT ME</b></h4> 
    </div>
  </div>
   </section>
       ...
       <div class="row d-flex mb-5 contact-info">
         ...
         <div class="col-md-3 d-flex">
           <div class="con align-self-stretch p-3">
             <p><span>Address:</span>34 Village Center Place, Suite 203, Mississauga, Ontario. L4Z 1V9</p>
           </div>
         </div>
         <div class="col-md-3 d-flex">
           <div class="con align-self-stretch p-3">
         ...
         <div class="col-md">
           <div class="ftco-footer-widget mb-4">
             ...
             <div class="block-23 mb-3">
               <ul>
                 <li><span class="icon icon-map-marker"></span><span class="text">34 Village Center Place, Suite 203, Mississauga, Ontario. L4Z 1V9</span></li>
